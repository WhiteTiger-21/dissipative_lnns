...
# Change swish define by lambda to function
# Add tanhshrink,hardswish,hardshrink
...
def choose_nonlinearity(name):
  ...
  if name == 'tanh':
    ...
    nl = swish
     ...
     nl = torch.nn.functional.tanhshrink
  elif name == 'hardswish' :
     nl = torch.nn.functional.hardswish
  elif name == 'hardshrink' :
     nl = torch.nn.functional.hardshrink
  else:
